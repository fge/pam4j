...
#ifndef __PAMHANDLE_H__
#define __PAMHANDLE_H__
#include <jni.h>
...
extern struct class_data classdata;
...
JNIEXPORT jint JNICALL Java_org_eel_kitchen_pam_PamHandle_destroyHandle(
    JNIEnv *env, jobject instance, jlong jhandle, jint status);

#ifdef __cplusplus
}
#endif

#endif /* __PAMHANDLE_H__ */
